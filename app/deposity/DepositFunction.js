...
export default function Homecard(props) {
  const {resultY, resultFF} = props;

  return(
    <div className='depositBoxss'>
      {
      resultY.slice(0, 3).map((a,i)=>(
        <div className="depositBox1" key={a}>
          ...
          <div className="explaneSubTitle">
            ...
            <div className="productHeader">
              ...
              <Link href={`detaily/${resultFF[i]}`} className='text-decoration'><div className="productTitle">{a.title}</div></Link>
            </div>
